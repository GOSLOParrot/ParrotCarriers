...
| `architecture/Interface/time_aligned_evidence_interface_20260515.md` | **Time-Aligned Evidence Web/backend SSOT** — TimebaseStamp、TimeAlignedSampleRef、TemporalEvidenceLedger、LiveKit/frame-cache/photo/BBox 证据流、CORE-012 晋升条件、CORE-014 BBox/MAG 生命周期 V1 |
