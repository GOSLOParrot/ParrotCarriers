# How To: Gateway Workspace Override Does Not Migrate Legacy Cron
...
Workflow: test gateway workspace override does not migrate legacy cron
...
### Step 18: Assign result = runner.invoke(...)
...
### Step 19: Assign unknown = store_path
...
*Source: test_commands.py:735 | Complexity: Advanced | Last updated: 2026-04-12*