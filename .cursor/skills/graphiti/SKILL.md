---
name: graphiti
description: Use when working with Graphiti temporal context graphs (add_episode, search, custom entity types, Neo4j/FalkorDB, group_id, MCP server)
---
...
*   **Facts/Relationships (edges)**: Triplets (e.g., Entity 鈫?Relationship 鈫?Entity) with temporal validity windows.
