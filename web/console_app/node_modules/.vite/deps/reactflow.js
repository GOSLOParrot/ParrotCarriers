...
var getNodePositionWithOrigin = (node, nodeOrigin = [0, 0]) => {
  ...
  const offsetX = ((_a = node.width) != null ? _a : 0) * nodeOrigin[0];
  const offsetY = ((_b = node.height) != null ? _b : 0) * nodeOrigin[1];
  const position = {
  ...
  return (handleBounds[type] || []).reduce((res, h) => {
    ...
    if (`${node.id}-${h.id}-${type}` !== currentHandle) {
      res.push({
        ...
        type,
        nodeId: node.id,
        x: ((_b = (_a = node.positionAbsolute) == null ? void 0 : _a.x) != null ? _b : 0) + h.x + h.width / 2,
        y: ((_d = (_c = node.positionAbsolute) == null ? void 0 : _c.y) != null ? _d : 0) + h.y + h.height / 2
      });
    }
    return res;
  }, []);
...
function calculateXYZPosition(node, nodeInternals, result, nodeOrigin) {
  ...
  return calculateXYZPosition(parentNode, nodeInternals, {
    x: ((_a = result.x) != null ? _a : 0) + parentNodePosition.x,
    y: ((_b = result.y) != null ? _b : 0) + parentNodePosition.y,
    z: ((_d = (_c = parentNode[internalsSymbol]) == null ? void 0 : _c.z) != null ? _d : 0) > ((_e = result.z) != null ? _e : 0) ? (_g = (_f = parentNode[internalsSymbol]) == null ? void 0 : _f.z) != null ? _g : 0 : (_h = result.z) != null ? _h : 0
  }, nodeOrigin);
}
...
function fitView(get3, options = {}) {
  ...
  if (d3initialized && (isInitialFitView || !options.initial)) {
    ...
    if (nodes.length > 0 && nodesInitialized) {
      ...
      const { x, y, zoom } = getViewportForBounds(bounds, width, height, (_a = options.minZoom) != null ? _a : minZoom, (_b = options.maxZoom) != null ? _b : maxZoom, (_c = options.padding) != null ? _c : 0.1);
    ...
    if (d3Selection && d3Zoom) {
      return {
        ...
        setViewport: (transform2, options) => {
          ...
          const nextTransform = identity3.translate((_a = transform2.x) != null ? _a : x, (_b = transform2.y) != null ? _b : y).scale((_c = transform2.zoom) != null ? _c : zoom);
        ...
        fitBounds: (bounds, options) => {
          ...
          const { x, y, zoom } = getViewportForBounds(bounds, width, height, minZoom, maxZoom, (_a = options == null ? void 0 : options.padding) != null ? _a : 0.1);
    ...
    if (d3Zoom) {
      if (userSelectionActive && !isZoomingOrPanning.current) {
        ...
        d3Zoom.on("zoom", (event) => {
          ...
          zoomedWithRightMouseButton.current = !!(onPaneContextMenu && isRightClickPan(panOnDrag, (_a = mouseButton.current) != null ? _a : 0));
          if ((onMove || onViewportChange) && !((_b = event.sourceEvent) == null ? void 0 : _b.internal)) {
            const flowTransform = eventToFlowTransform(event.transform);
  ...
  (0, import_react2.useEffect)(() => {
    if (d3Zoom) {
      d3Zoom.on("end", (event) => {
        ...
        if (onPaneContextMenu && isRightClickPan(panOnDrag, (_a = mouseButton.current) != null ? _a : 0) && !zoomedWithRightMouseButton.current) {
    ...
    if (nodeRef == null ? void 0 : nodeRef.current) {
      ...
      const updateNodes = ({ x, y }) => {
        ...
        dragItems.current = dragItems.current.map((n) => {
          ...
          if (dragItems.current.length > 1 && nodeExtent && !n.extent) {
            ...
            adjustedNodeExtent[1][0] = n.positionAbsolute.x + ((_a = n.width) != null ? _a : 0) - nodesBox.x2 + nodeExtent[1][0];
            adjustedNodeExtent[0][1] = n.positionAbsolute.y - nodesBox.y + nodeExtent[0][1];
            adjustedNodeExtent[1][1] = n.positionAbsolute.y + ((_b = n.height) != null ? _b : 0) - nodesBox.y2 + nodeExtent[1][1];
          }
      ...
      const autoPan = () => {
        ...
        if (xMovement !== 0 || yMovement !== 0) {
          ...
          lastPos.current.x = ((_a = lastPos.current.x) != null ? _a : 0) - xMovement / transform2[2];
          lastPos.current.y = ((_b = lastPos.current.y) != null ? _b : 0) - yMovement / transform2[2];
      ...
      if (disabled) {
        ...
        const dragHandler = drag_default().on("start", (event) => {
          ...
          if (!dragStarted.current) {
            const x = pointerPos.xSnapped - ((_b = (_a = lastPos == null ? void 0 : lastPos.current) == null ? void 0 : _a.x) != null ? _b : 0);
            const y = pointerPos.ySnapped - ((_d = (_c = lastPos == null ? void 0 : lastPos.current) == null ? void 0 : _c.y) != null ? _d : 0);
...
var NodeRenderer = (props) => {
  ...
  return import_react2.default.createElement("div", { className: "react-flow__nodes", style: containerStyle }, nodes.map((node) => {
    ...
    return import_react2.default.createElement(NodeComponent, { key: node.id, id: node.id, className: node.className, style: node.style, type: nodeType, data: node.data, sourcePosition: node.sourcePosition || Position.Bottom, targetPosition: node.targetPosition || Position.Top, hidden: node.hidden, xPos: posX, yPos: posY, xPosOrigin: posOrigin.x, yPosOrigin: posOrigin.y, selectNodesOnDrag: props.selectNodesOnDrag, onClick: props.onNodeClick, onMouseEnter: props.onNodeMouseEnter, onMouseMove: props.onNodeMouseMove, onMouseLeave: props.onNodeMouseLeave, onContextMenu: props.onNodeContextMenu, onDoubleClick: props.onNodeDoubleClick, selected: !!node.selected, isDraggable, isSelectable, isConnectable, isFocusable, resizeObserver, dragHandle: node.dragHandle, zIndex: (_f = (_e = node[internalsSymbol]) == null ? void 0 : _e.z) != null ? _f : 0, isParent: !!((_g = node[internalsSymbol]) == null ? void 0 : _g.isParent), noDragClassName: props.noDragClassName, noPanClassName: props.noPanClassName, initialized: !!node.width && !!node.height, rfId: props.rfId, disableKeyboardA11y: props.disableKeyboardA11y, ariaLabel: node.ariaLabel, hasHandleBounds: !!((_h = node[internalsSymbol]) == null ? void 0 : _h.handleBounds) });
  }));
};
  ...
  return import_react2.default.createElement(
    ...
    edgeTree.map(({ level, edges, isMaxLevel }) => import_react2.default.createElement(
      ...
      import_react2.default.createElement("g", null, edges.map((edge) => {
        ...
        const targetNodeHandles = connectionMode === ConnectionMode.Strict ? targetHandleBounds.target : ((_a = targetHandleBounds.target) != null ? _a : []).concat((_b = targetHandleBounds.source) != null ? _b : []);
...
var ConnectionLine = ({ nodeId, handleType, style: style2, type = ConnectionLineType.Bezier, CustomComponent, connectionStatus }) => {
  ...
  const fromHandleX = fromHandle ? fromHandle.x + fromHandle.width / 2 : ((_b = fromNode.width) != null ? _b : 0) / 2;
  const fromHandleY = fromHandle ? fromHandle.y + fromHandle.height / 2 : (_c = fromNode.height) != null ? _c : 0;
  const fromX = ((_e = (_d = fromNode.positionAbsolute) == null ? void 0 : _d.x) != null ? _e : 0) + fromHandleX;
  const fromY = ((_g = (_f = fromNode.positionAbsolute) == null ? void 0 : _f.y) != null ? _g : 0) + fromHandleY;
...
function ResizeControl({ nodeId, position, variant = ResizeControlVariant.Handle, className, style: style2 = {}, children: children2, color: color2, minWidth = 10, minHeight = 10, maxWidth = Number.MAX_VALUE, maxHeight = Number.MAX_VALUE, keepAspectRatio = false, shouldResize, onResizeStart, onResize, onResizeEnd }) {
  ...
  (0, import_react7.useEffect)(() => {
    ...
    const dragHandler = drag_default().on("start", (event) => {
      ...
      prevValues.current = {
        width: (_a = node == null ? void 0 : node.width) != null ? _a : 0,
        height: (_b = node == null ? void 0 : node.height) != null ? _b : 0,
        x: (_c = node == null ? void 0 : node.position.x) != null ? _c : 0,
        y: (_d = node == null ? void 0 : node.position.y) != null ? _d : 0
      };
      startValues.current = {
        ...prevValues.current,
        pointerX: xSnapped,
...
// dep:reactflow
var reactflow_default = ReactFlow;
export {
