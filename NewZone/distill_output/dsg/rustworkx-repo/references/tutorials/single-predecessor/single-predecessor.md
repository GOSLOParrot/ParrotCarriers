...
Workflow: test single predecessor
...
### Step 5: Assign res_even = dag.find_predecessors_by_edge(...)

```python
res_even = dag.find_predecessors_by_edge(node_c, lambda x: x['a'] % 2 == 0)
```

### Step 6: Assign res_odd = dag.find_predecessors_by_edge(...)
...
*Source: test_pred_succ.py:117 | Complexity: Advanced | Last updated: 2026-05-05*