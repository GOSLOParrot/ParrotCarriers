...
Workflow: test path 2 tensor path 3
...
### Step 1: Assign graph_1 = rustworkx.generators.path_graph(...)

```python
graph_1 = rustworkx.generators.path_graph(2)
```

### Step 2: Assign graph_2 = rustworkx.generators.path_graph(...)

```python
graph_2 = rustworkx.generators.path_graph(3)
```

### Step 3: Assign unknown = rustworkx.graph_tensor_product(...)
...
*Source: test_tensor_product.py:40 | Complexity: Advanced | Last updated: 2026-05-05*