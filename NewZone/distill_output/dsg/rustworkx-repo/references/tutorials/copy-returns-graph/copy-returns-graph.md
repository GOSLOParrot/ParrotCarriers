...
Workflow: test copy returns graph
...
### Step 7: Assign graph_b = graph_a.copy(...)
...
*Source: test_copy.py:19 | Complexity: Advanced | Last updated: 2026-05-05*