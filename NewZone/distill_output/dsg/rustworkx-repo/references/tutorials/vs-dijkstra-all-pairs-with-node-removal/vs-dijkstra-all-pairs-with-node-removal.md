# How To: Vs Dijkstra All Pairs With Node Removal
...
Workflow: test vs dijkstra all pairs with node removal
...
### Step 10: Call graph.remove_node()

```python
graph.remove_node(d)
```

### Step 11: Assign dijkstra_lengths = rustworkx.graph_all_pairs_dijkstra_path_lengths(...)
...
### Step 13: Assign result = rustworkx.graph_floyd_warshall(...)
...
*Source: test_floyd_warshall.py:54 | Complexity: Advanced | Last updated: 2026-05-05*