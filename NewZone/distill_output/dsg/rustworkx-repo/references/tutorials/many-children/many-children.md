...
### Step 3: Assign res_even = dag.find_successors_by_edge(...)

```python
res_even = dag.find_successors_by_edge(node_a, lambda x: x['edge'] % 2 == 0)
```

### Step 4: Assign res_odd = dag.find_successors_by_edge(...)
...
*Source: test_pred_succ.py:213 | Complexity: Intermediate | Last updated: 2026-05-05*