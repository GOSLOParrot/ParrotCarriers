# How To: Old Fact Is Warm Or Cold
...
Workflow: test old fact is warm or cold
...
```python
fact = AtomicFact(fact_id='lf2', content='Old fact', created_at=old_date, access_count=0)
```
...
*Source: test_trust_compliance_wiring.py:437 | Complexity: Intermediate | Last updated: 2026-05-05*