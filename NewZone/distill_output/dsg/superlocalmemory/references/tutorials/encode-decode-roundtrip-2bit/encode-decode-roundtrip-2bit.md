# How To: Encode Decode Roundtrip 2Bit
...
Workflow: Test 3: 2-bit avg MSE < 0.5 (4 centroids on [-1,1] — archival quality).
...
### Step 1: 'Test 3: 2-bit avg MSE < 0.5 (4 centroids on [-1,1] — archival quality).'
...
*Source: test_turbo_quant.py:128 | Complexity: Intermediate | Last updated: 2026-05-05*