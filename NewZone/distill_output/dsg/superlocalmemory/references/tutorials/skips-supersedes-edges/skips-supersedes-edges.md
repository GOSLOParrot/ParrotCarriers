...
Workflow: test skips supersedes edges
...
```python
edge = GraphEdge(edge_id='e1', source_id='f1', target_id='f2', edge_type=EdgeType.SUPERSEDES)
```
...
*Source: test_sheaf.py:229 | Complexity: Intermediate | Last updated: 2026-05-05*