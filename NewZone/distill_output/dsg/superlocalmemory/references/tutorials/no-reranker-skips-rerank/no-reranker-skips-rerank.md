# How To: No Reranker Skips Rerank
...
Workflow: test no reranker skips rerank
...
```python
engine = _build_engine(db=db, semantic_results=[('f1', 0.9)], reranker=None)
```
...
*Source: test_engine.py:261 | Complexity: Intermediate | Last updated: 2026-05-05*