...
Workflow: Second checkpoint for same file within cooldown should NOT observe.
...
### Step 1: 'Second checkpoint for same file within cooldown should NOT observe.'
...
### Step 2: Assign file_path = '/project/src/rate_test.py'
...
### Step 7: Call mock_daemon_post.assert_not_called()
...
*Source: test_hook_handlers.py:510 | Complexity: Advanced | Last updated: 2026-05-05*