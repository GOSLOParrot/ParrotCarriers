# How To: Filter Passes Active Unchanged
...
Workflow: Active-zone facts should keep their original score (weight=1.0).
...
### Step 1: 'Active-zone facts should keep their original score (weight=1.0).'
...
```python
retention_data = {'fact_active': {'fact_id': 'fact_active', 'retention_score': 0.9, 'lifecycle_zone': 'active'}}
```
...
```python
all_results = {'semantic': [('fact_active', 0.85)]}
```
...
*Source: test_forgetting_filter.py:98 | Complexity: Intermediate | Last updated: 2026-05-05*