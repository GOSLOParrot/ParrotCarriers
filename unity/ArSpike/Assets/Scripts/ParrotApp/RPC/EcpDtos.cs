...
public class EcpFrontendStateDto
{
    ...
    /// <summary>
    /// Sprint4 Phase 3 增加：连接健康 4 态聚合（healthy / degraded / unhealthy / unknown）。
    /// 来源：<c>ConnectionHealthAggregator.Snapshot.Overall</c>。
    /// 决策见 <c>docs/sprint4_research/result/INDEX_for_phase3.md §1 #13</c>。
    ///
    /// 注意：EcpAck.frontend_state 只携带 4 态聚合；完整 ConnectionHealthState 走
    /// 周期 <see cref="EcpStateDto"/> 上报，不挤进 per-command ack。
    /// </summary>
