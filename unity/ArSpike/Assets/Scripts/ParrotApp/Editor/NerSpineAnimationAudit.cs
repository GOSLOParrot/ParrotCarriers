...
namespace ParrotApp.Editor
{
    ...
    {
        private const string SkeletonDataPath = "Assets/Models/Ner/NerSkin2_SkeletonData.asset";
        private const string ManifestPath = "Assets/Resources/parrot_models/ner_skin2.json";
