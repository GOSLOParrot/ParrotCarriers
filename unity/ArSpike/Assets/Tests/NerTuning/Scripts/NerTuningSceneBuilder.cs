...
namespace ParrotApp.NerTuning.Editor
{
    ...
    /// It deliberately writes only under Assets/Tests/NerTuning.
    /// </summary>
    public static class NerTuningSceneBuilder
    {
        private const string MenuPath = "ParrotApp/Ner/Rebuild Mouse Tuning Test Scene";
        private const string RootFolder = "Assets/Tests/NerTuning";
        private const string ScenesFolder = "Assets/Tests/NerTuning/Scenes";
        private const string PrefabsFolder = "Assets/Tests/NerTuning/Prefabs";
        private const string MaterialsFolder = "Assets/Tests/NerTuning/Materials";
        private const string ScenePath = "Assets/Tests/NerTuning/Scenes/NerMouseTuningScene.unity";
        private const string PrefabPath = "Assets/Tests/NerTuning/Prefabs/NerMouseTuningRig.prefab";
        private const string GroundMaterialPath = "Assets/Tests/NerTuning/Materials/NerTuningGround.mat";
        private const string GridMaterialPath = "Assets/Tests/NerTuning/Materials/NerTuningGrid.mat";
        private const string MarkerMaterialPath = "Assets/Tests/NerTuning/Materials/NerTuningMarker.mat";
        private const string SkeletonPath = "Assets/ParrotApp/Models/Ner/NerSkin2_SkeletonData.asset";
