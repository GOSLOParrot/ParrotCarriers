...
namespace ParrotApp.Config
{
    ...
    {
        // Internal launch baseline selected by startup/device policy, such as
        // AR handheld vs editor webcam. User-facing RoomSetting should not ask
        // the user to classify desktop/indoor/outdoor here; visible theme/UI
        // suite choices are carried by skin_id.
        ...
        // App backend read/control surfaces. These are loaded from
        // Resources/parrot_config.json in runtime clients; they are mirrored
        // here so START can carry the selected compatibility tier without
        // introducing a separate session-global singleton.
        public string app_api_url = "";
        public string orchestrator_url = "";
        public string orchestrator_secret = "";
        public int setting_change_tier = 0;
        public string compatibility_state = "";
        public string compatibility_summary = "";
        public bool requires_livekit_reconnect = false;
        ...
        public void Normalize()
        {
            ...
            if (setting_change_tier < 0) setting_change_tier = 0;
