...
def build_app(
    ...
    async def runtime_workflow_result_contract(  # type: ignore[misc]
        payload: dict[str, Any] | None = Body(default=None),
    ) -> dict[str, Any]:
    ...
    async def runtime_workflow_result_intake(  # type: ignore[misc]
        payload: dict[str, Any] | None = Body(default=None),
    ) -> dict[str, Any]:
    ...
    async def runtime_workflow_action_gates(
        state: str = "pending",
        q: str = "",
        limit: int = 50,
    ) -> dict[str, Any]:
    ...
    async def runtime_workflow_action_gate_draft(  # type: ignore[misc]
        payload: dict[str, Any] | None = Body(default=None),
    ) -> dict[str, Any]:
    ...
    async def runtime_workflow_action_gate_decision(  # type: ignore[misc]
        payload: dict[str, Any] | None = Body(default=None),
    ) -> dict[str, Any]:
    ...
    async def runtime_workflow_action_gate_delete(gate_id: str) -> dict[str, Any]:
