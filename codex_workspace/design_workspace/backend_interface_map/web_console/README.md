...
| `workspace_ref_sync_design_20260527.md` | first_backend_slice | CORE-015 | Current design and first helper for syncing large-file/locator refs across IntentWorkspace, nanobot actor scope, IdentityRefIndex, and L2-B pointer Nodes/Edges without file moves or Graphiti mutation. |
