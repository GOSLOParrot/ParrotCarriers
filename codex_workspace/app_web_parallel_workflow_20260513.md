...
| `codex_workspace/design_workspace/backend_interface_map/app/local_laptop_castle_app_env_20260518.md` | Unity App local laptop Castle sandbox for iQOO / LiveKit latency and audio-route comparison. | App chat owns. Use this route only through `infra/laptop-castle.ps1`; do not copy ECS secrets or shared `data/runtime_config.json` into the sandbox. |
